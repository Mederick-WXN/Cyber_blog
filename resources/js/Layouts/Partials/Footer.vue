...
<template>
  ...
  <div class="flex justify-center items-center space-x-1">
    ...
    <a href="#" data-tooltip-target="tooltip-github" class="inline-flex justify-center p-2 text-white rounded-lg cursor-pointer hover:text-white hover:bg-[#1e94d1]">
        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div id="tooltip-github" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip" aria-hidden="true">
        Star us on GitHub
        <div class="tooltip-arrow" data-popper-arrow></div>
    </div>
</div>
